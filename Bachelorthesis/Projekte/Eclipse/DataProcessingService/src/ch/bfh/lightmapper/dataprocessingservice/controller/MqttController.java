...
public class MqttController {
	...
	public static final String CLIENT_USERNAME = "Datenverarbeitungs-Service";
	public static final String TPC_HEAD = "ch/bfh/bachelorthesis/ledmapper/data_processing/";
	...
	public static final String TPC_DATA_PROCESSING_IN_REFERENCE_PICTURE = TPC_HEAD + "input/reference_picture/";
	public static final String TPC_DATA_PROCESSING_IN_COMPARSION_PICTURE = TPC_HEAD + "input/comparsion_picture/";
	public static final String TPC_DATA_PROCESSING_OUT_COORDINATE = TPC_HEAD + "output/coordinate/";
	public static final String TPC_DATA_PROCESSING_OUT_STATUS = TPC_HEAD + "output/status/";
	public static final String TPC_DATA_PROCESSING_OUT_SERVICE_AVAILABLE = TPC_HEAD + "output/service_available/";
	...
	public void disconnect() throws MqttException, UnsupportedEncodingException {
		if (this.mqttClient != null && this.mqttClient.isConnected()) {
			...
			publish(TPC_DATA_PROCESSING_OUT_SERVICE_AVAILABLE, MSG_DATA_PROCESSING_IS_GONE +
	...
	private MqttConnectOptions setConnectOptions() {
        ...
        connectOptions.setWill(TPC_DATA_PROCESSING_OUT_SERVICE_AVAILABLE, (MSG_DATA_PROCESSING_IS_GONE +
        		MSG_PART_SPLIT_CHARACTER + CLIENT_USERNAME +
	...
	public void subscribeToAllTopics(IMqttActionListener subscribeListener) throws MqttException {
		 ...
		 * werden.
		 */
		subscribe(TPC_DATA_PROCESSING_IN_REFERENCE_PICTURE, QOS_0, subscribeListener);
        subscribe(TPC_DATA_PROCESSING_IN_COMPARSION_PICTURE, QOS_0, subscribeListener);
	}
